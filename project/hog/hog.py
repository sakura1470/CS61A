...
def free_bacon(score):
    ...
    return int((pi // pow(10, 100 - score) ) - (pi // pow(10, 101 - score)) * 10) + 3
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal :
        if who == 0 :
            cur_score, opponent_score, cur_strategy = score0, score1, strategy0
        else :
            cur_score, opponent_score, cur_strategy = score1, score0, strategy1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def highest(score0, score1):
        if who == 0:
            highest_score = score0
        else:
            highest_score = score1
        cur_high = highest_score - last_score
        if cur_high > running_high:
            print(cur_high, 'point(s)! The most yet for Player', who)
            return announce_highest(who, highest_score, cur_high)
        return announce_highest(who, highest_score, running_high)
    return highest
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def make_averaged_rice(*args):
        total = 0
        for i in range(trials_count):
            result = original_function(*args)
            total += result
        return total / trials_count
    return make_averaged_rice
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(1, 11):
        ...
        cur_score = averaged_roll_dice(i,dice)
